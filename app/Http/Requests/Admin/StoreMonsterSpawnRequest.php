...
class StoreMonsterSpawnRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'min_instances' => ['required', 'integer', 'min:0'],
            'max_instances' => ['required', 'integer', 'min:1', 'gte:min_instances'],
            'respawn_time_min' => ['required', 'integer', 'min:1'],
            'respawn_time_max' => ['required', 'integer', 'min:1', 'gte:respawn_time_min'],
