...
class StoreNpcRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'string', Rule::in(['trader', 'teacher', 'quest_giver', 'simple', 'hostile'])],
            ...
            'stats.strength' => ['required', 'integer', 'min:1', 'max:100'],
            'stats.agility' => ['required', 'integer', 'min:1', 'max:100'],
            'stats.intelligence' => ['required', 'integer', 'min:1', 'max:100'],
