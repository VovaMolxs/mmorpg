...
class NpcSpawn extends Model
{
    ...
    /**
     * Активные NPC, созданные этим спавном.
     */
    public function activeNpcs(): HasMany
    {
        return $this->hasMany(ActiveNpc::class, 'spawn_id')
            ->where('is_active', true);
    }

    /**
     * Все NPC, созданные этим спавном.
     */
    public function allActiveNpcs(): HasMany
    {
        return $this->hasMany(ActiveNpc::class, 'spawn_id');
    }

    /**
     * Получить количество активных NPC в локации.
     */
    public function getActiveCount(): int
    {
        return $this->activeNpcs()->count();
    }

    /**
     * Проверить, нужно ли спавнить NPC.
     */
    ...
    public function canRespawn(): bool
    {
        ...
        $maxRespawnTime = now()->subMinutes($this->respawn_time_max);
