...
@section('title', 'Создать банкира')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-semibold mb-2">Создать банкира</h1>
        <a
    ...
    <form method="POST" action="{{ route('admin.bankers.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('max_upgrade_slots', 100) }}"
                        min="1"
                        max="1000"
                        required
                        class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded bg-white dark:bg-[#0a0a0a] focus:outline-none focus:ring-2 focus:ring-[#f53003] dark:focus:ring-[#FF4433]"
