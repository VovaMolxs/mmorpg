...
@section('title', 'Управление спавном монстров')

@section('content')
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl sm:text-3xl font-semibold">Управление спавном монстров</h1>
        @include('admin.partials.menu', [
            'additionalButtons' => [
                ['route' => route('admin.monster-spawns.create'), 'label' => 'Создать спавн'],
    ...
    <div class="bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg p-4 sm:p-6 mb-6">
        <form method="GET" action="{{ route('admin.monster-spawns.index') }}" class="flex flex-col sm:flex-row gap-4">
            <select
                name="location_id"
                    ...
                    <tr>
                        ...
                        <td class="px-3 sm:px-6 py-4 text-sm font-medium">
                            <div class="flex flex-col">
                                ...
                                <span class="text-xs text-gray-500 dark:text-gray-400">Уровень: {{ $spawn->monster->level }}</span>
                            </div>
                        </td>
                        ...
                        <td class="px-3 sm:px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex gap-2">
                                <a
                                    href="{{ route('admin.monster-spawns.edit', $spawn) }}"
                                ...
                                <form
                                    method="POST"
                                    action="{{ route('admin.monster-spawns.destroy', $spawn) }}"
                                    class="inline"
