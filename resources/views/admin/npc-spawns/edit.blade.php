...
@section('title', 'Редактировать спавн NPC')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-semibold mb-2">Редактировать спавн NPC</h1>
        <a
    ...
    <form method="POST" action="{{ route('admin.npc-spawns.update', $spawn) }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    >
                        ...
                        @foreach($npcs as $npc)
                            <option value="{{ $npc->id }}" {{ old('npc_id', $spawn->npc_id) == $npc->id ? 'selected' : '' }}>
